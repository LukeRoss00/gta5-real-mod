...
6. If you have an Oculus/Facebook Quest or Quest 2, you must connect it to your PC using a USB cable (preferably USB 3 for best quality). Virtual Desktop does NOT support the mod for the moment, and if you try to connect wirelessly you will have unacceptable stutter. If instead you are using a WMR headset, please see the [release notes](https://github.com/LukeRoss00/gta5-real-mod/releases) for important information.
