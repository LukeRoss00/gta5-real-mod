...
**Apr 4 Update:** *Rockstar has pushed a new game version, so now in order to make the R.E.A.L. mod work you should also download the latest Script Hook V from Alexander Blade's page (http://www.dev-c.com/gtav/scripthookv/, or [here](https://github.com/LukeRoss00/gta5-real-mod/files/4640220/ScriptHookV_1.0.1868.1.zip) in case AB's site is down) and use it to update the `ScriptHookV.dll` file in the main game folder; the other files in `ScriptHookV_1.0.1868.1.zip` are unchanged and you don't need to replace them.*
